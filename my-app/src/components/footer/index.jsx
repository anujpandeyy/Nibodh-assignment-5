    ...
    return (
        ...
        <div className="row justify-content-evenly">
            <div className="col-2 mt-5 mx-5 px-5">
                <img className="img-fluid logo-custom" src="https://www.buythelogo.com/wp-content/uploads/2019/03/Star-one-1-abstract-logo.jpg" alt="" />
                <p className="logot text-uppercase">Helping People</p>
                <div className="">
                    <h6>About Us</h6>
            ...
            <div className="col-4 mt">
                <div className="row">
                    <div className="col-5">
                        <h6>OPENING HOURS</h6>
                        <div><i className="fas fa-phone-alt"></i> &nbsp;+91-555-555</div>
